...
public class DriverSqlService {
    ...
    public DriverSqlService(NamedParameterJdbcOperations jdbcOperations, PasswordEncoder passwordEncoder) {
    ...
    public Integer createUser(
        ...
        MapSqlParameterSource parameters = insertUserParameterSource(
...
//    public DriverDto getUserByEmailAndPassword(String email, String password) throws DgAuthException {
